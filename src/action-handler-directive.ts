...
customElements.define('action-handler-apsley-scheduler', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-apsley-scheduler')) {
    return body.querySelector('action-handler-apsley-scheduler') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-apsley-scheduler');
